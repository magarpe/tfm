...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.mvpMapPoints_Ids))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.pack(pattern, *self.mvpMapPoints_VectId))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.mvpMapPoints_Ids = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.mvpMapPoints_VectId = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 7
