...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_I().pack(self.mMsgId))
      ...
      for val1 in self.Keyframes:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.pack(pattern, *val1.mvpMapPoints_Ids))
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sH'%length
        buff.write(struct.pack(pattern, *val1.mvpMapPoints_VectId))
        _x = val1
      ...
      for val1 in self.MapPoints:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sH'%length
        buff.write(struct.pack(pattern, *val1.mObservations_KFIDs))
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sH'%length
        buff.write(struct.pack(pattern, *val1.mObservations_n))
        buff.write(_get_struct_3f().pack(*val1.mNormalVector))
        buff.write(_get_struct_B().pack(val1.mbNormalAndDepthChanged))
        _x = val1.mDescriptor
        # - if encoded as a list instead, serialize as bytes instead of string
        if type(_x) in [list, tuple]:
          buff.write(_get_struct_32B().pack(*_x))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.pack(pattern, *self.vAckKFs))
      length = len(self.vAckMPs)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.vAckMPs))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.mvpMapPoints_Ids = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        val1.mvpMapPoints_VectId = struct.unpack(pattern, str[start:end])
        _x = val1
        start = end
        end += 7
      ...
      for i in range(0, length):
        ...
        val1.mObservations_KFIDs = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        val1.mObservations_n = struct.unpack(pattern, str[start:end])
        start = end
        end += 12
      ...
      self.vAckKFs = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.vAckMPs = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 9
